 ...
 * @date 2019/1/2
 */
public class UpdateDialogFragment extends BaseDialogFragment implements View.OnClickListener, OnProgressBarListener {
    ...
    protected void initView(Dialog view) {
        ...
        btnUpdateLater.setOnClickListener(this);
